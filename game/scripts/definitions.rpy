...
define nq = Character("???", color=nari_color, what_outlines=[(color_outline_thickness, nari_color, 0, 0),(black_outline_thickness, "#000", 0, 0)], who_outlines=[(5, "#222", 0, 0)], callback=blip_vox_variance, cb_char="n", what_prefix="{cps=30}", what_suffix="{/cps}")

define iqw = Character(kind=iq, cb_char="iw", what_prefix="{cps=200}{shader=jitter:u__jitter=5.0, 5.0}", what_suffix="{/shader}{/cps}")
...
define cs = Character("CHRIS", kind=cq, what_prefix="{cps=40}", what_suffix="{/cps}") # this is only used when she's sad

define ca = Character("CHRIS", kind=cq, cb_char="ca")
define iw = Character("ISADORA", kind=iq, cb_char="iw", what_prefix="{cps=200}{shader=jitter:u__jitter=5.0, 5.0}", what_suffix="{/shader}{/cps}")
...
if persistent.SeenNari == None:
    $persistent.SeenNari = False
